...
const socialMedia = [
  { name: 'Facebook', icon: Facebook, username: 'PMR Wira Smkn Prbya', url: 'https://www.facebook.com/share/1FnbuMwaff/', color: 'bg-[#1877f2]' },
  { name: 'Instagram', icon: Instagram, username: 'laspraja_smkn1baya', url: 'https://www.instagram.com/laspraja_smkn1baya', color: 'bg-gradient-to-r from-[#f09433] to-[#bc1888]' },
  { name: 'TikTok', icon: Send, username: 'PMR WIRA SMKN 1 PRINGGABAYA', url: 'https://www.tiktok.com/@pmrsmeksaofficial', color: 'bg-[#000000]' },
  { name: 'YouTube', icon: Youtube, username: 'PMR Wira Unit SMKN 1 Pringgabaya', url: 'https://www.youtube.com/@pmrwira.smkn1pringgabaya', color: 'bg-[#ff0000]' },
];
  ...
  return (
    <div className="pt-20 pb-16">
      <div className="container-custom">
        ...
        {/* Media Sosial */}
        <h2 className="text-2xl font-bold mb-6">Media Sosial Resmi</h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {socialMedia.map((social, idx) => (
            <a
              ...
              className="group bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition"
            >
              <div className={`w-16 h-16 mx-auto rounded-full ${social.color} flex items-center justify-center mb-4 group-hover:scale-110 transition`}>
                <social.icon className="w-8 h-8 text-white" />
              </div>
              <h3 className="font-bold text-lg mb-1">{social.name}</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 break-all">{social.username}</p>
              <p className="text-pmi text-sm mt-2">Kunjungi →</p>
            </a>
          ))}
        </div>
